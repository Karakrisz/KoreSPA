...
declare global {
  ...
  const categories: typeof import('../../utils/data')['categories']
  ...
  const items: typeof import('../../utils/data')['items']
...
declare global {
  ...
  // @ts-ignore
  export type { Category, CategoryOrSearch, Item } from '../../utils/data'
  import('../../utils/data')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly categories: UnwrapRef<typeof import('../../utils/data')['categories']>
    ...
    readonly items: UnwrapRef<typeof import('../../utils/data')['items']>
